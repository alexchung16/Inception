...
from GoogLeNet_Tensorflow.Inception_v1 import InceptionV1
import numpy as np
        ...
        try:
            if not coord.should_stop():
                for epoch in range(STEP_NUM):
                    ...
                    _, loss_value, train_accuracy, logits= sess.run(fetches=[inception_v1.train,
                                                                      inception_v1.loss,
                                                                      inception_v1.evaluate_accuracy, inception_v1.logits],
                                                             feed_dict=feed_dict)
                    # print(logits)
