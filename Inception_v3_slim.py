...
class InceptionV3():
            ...
            with slim.arg_scope([slim.batch_norm, slim.dropout], is_training=is_training):
                with slim.arg_scope([slim.conv2d],
                    ...
                    with tf.compat.v1.variable_scope('Logits'):
                        ...
                        logits = slim.conv2d(inputs=net, num_outputs=num_classes, kernel_size=[1, 1], strides=1,
                                             scope='Conv2d_1c_1x1')
    ...
    def inception_v3_base(self, inputs, scope='InceptionV3'):
        ...
        with tf.compat.v1.variable_scope(scope, default_name='InceptionV3', values=[inputs]):
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='VALID'):
                ...
                # 35 x 35 x 192
                net = self.inception_module_v3_a(inputs=net, outputs_list=[64, 48, 64, 64, 96, 96, 32], scope='Mixed_5b')
                # 35 x 35 x 256
                net = self.inception_module_v3_a(inputs=net, outputs_list=[64, 48, 64, 64, 96, 96, 64], scope='Mixed_5c')
                # 35 x 35 x 288
                net = self.inception_module_v3_a(inputs=net, outputs_list=[64, 48, 64, 64, 96, 96, 64], scope='Mixed_5d')
                ...
                # 17 x 17 x 1280
                net = self.inception_module_v3_c(inputs=net,
    ...
    def inception_module_v3_a(self, inputs, outputs_list, scope):
        """
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
                ...
                with tf.compat.v1.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(inputs=inputs, num_outputs=outputs_list[1], kernel_size=[1, 1], stride=1,
                                           scope='Conv2d_0a_1x1')
                    branch_1 = slim.conv2d(inputs=branch_1, num_outputs=outputs_list[2], kernel_size=[1, 1], stride=1,
                                           scope='Conv2d_0b_5x5')
                # branch 2
    ...
    def inception_module_v3_c(self, inputs, outputs_list, scope):
        """
        ...
        with tf.compat.v1.variable_scope(scope):
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
                ...
                with tf.compat.v1.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(inputs=branch_1, num_outputs=outputs_list[5], kernel_size=[3, 3], stride=1,
                                           scope='Conv2d_1a_3x3', padding='VALID')
                # branch 2
                with tf.compat.v1.variable_scope('Branch_2'):
                    branch_2 = slim.max_pool2d(inputs=inputs, kernel_size=[3, 3], stride=2, scope='MaxPool_1a_3x3',
